!function() {
      ...
      ? /^data\:/i.test(b.src)
        ...
        : /^blob\:/i.test(b.src)
          ...
          : ((g = new XMLHttpRequest()),
            ...
            g.send(null))
      : window.FileReader &&
        (b instanceof window.Blob || b instanceof window.File) &&
        ((f = new FileReader()),
        (f.onload = function(b) {
          a && console.log("Got file of length " + b.target.result.byteLength),
            d(b.target.result);
        }),
  ...
  function m(b) {
    var f,
      ...
      c = new DataView(b);
    if (
      (a && console.log("Got file of length " + b.byteLength),
      255 != c.getUint8(0) || 216 != c.getUint8(1))
    )
    ...
    for (d = 2, e = b.byteLength; e > d; ) {
      if (255 != c.getUint8(d))
        return (
          a &&
            console.log(
              "Not a valid marker at offset " + d + ", found: " + c.getUint8(d)
            ),
          !1
        );
      if (((f = c.getUint8(d + 1)), a && console.log(f), 225 == f))
        return (
          a && console.log("Found 0xFFE1 marker"),
          u(c, d + 4, c.getUint16(d + 2) - 2)
        );
      d += 2 + c.getUint16(d + 2);
    }
  }
  ...
  function q(a, b, c) {
    for (var f, g, h, i, j, d = new DataView(a), e = {}, k = b; b + c > k; )
      28 === d.getUint8(k) &&
        2 === d.getUint8(k + 1) &&
        ((i = d.getUint8(k + 2)),
        i in p &&
  ...
  function r(b, c, d, e, f) {
    ...
    for (k = 0; g > k; k++)
      (i = d + 12 * k + 2),
        (j = e[b.getUint16(i, !f)]),
        !j && a && console.log("Unknown tag: " + b.getUint16(i, !f)),
        (h[j] = s(b, i, c, d, f));
    return h;
  }
  ...
  function u(b, c) {
    var h, i, j, k, l, m, n;
    if ("Exif" != t(b, c, 4))
      return a && console.log("Not valid EXIF data! " + t(b, c, 4)), !1;
    if (((m = c + 6), 18761 == b.getUint16(m))) h = !1;
    else {
      if (19789 != b.getUint16(m))
        return (
          a && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"), !1
        );
      h = !0;
    }
    if (42 != b.getUint16(m + 2, !h))
      return a && console.log("Not valid TIFF data! (no 0x002A)"), !1;
    if (((n = b.getUint32(m + 4, !h)), 8 > n))
      return (
        a &&
          console.log(
  ...
  "undefined" != typeof exports
    ...
    (c.getData = function(a, b) {
      return (a instanceof Image || a instanceof HTMLImageElement) &&
        !a.complete
        ? !1
        : (i(a) ? b && b.call(a) : l(a, b), !0);
    }),
