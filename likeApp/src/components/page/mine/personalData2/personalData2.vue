<template>
  <div class="personal" ref="personalWrapper">
    ...
    <pull-to :top-load-method="handleTop" @infinite-scroll="handleBottom" 
               :top-config="{triggerText:'释放刷新',loadingText:'刷新中...',doneText:'刷新完成'}"
               :is-bottom-bounce="!showLoadingend" 
              >
